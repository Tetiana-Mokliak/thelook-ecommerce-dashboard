...
**Зображення та опис спостережень відображають стан на 25 вересня 2026 року.** Дашборд і публічний датасет оновлюються, тому після відкриття звіту кількості й окремі закономірності можуть відрізнятися. Перед використанням поточних результатів перевірки слід виконати повторно.
